...
export function RegistrationForm() {
  ...
  return <div className="registration-grid">
    <div className="form-card"><h2>Your details</h2><p className="form-intro">Your photograph stays in this browser and is never uploaded.</p>
