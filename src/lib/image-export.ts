...
export async function cardToFile(node: HTMLElement, filename: string) {
  ...
  const dataUrl = await toPng(node, { width: 1080, height: 1080, pixelRatio: 1, cacheBust: true, backgroundColor: "#090914", style: { transform: "none", width: "1080px", height: "1080px" } });
